...
![EnablePlugin](docs/screenshots/enable_plugin.png)
<!-- RELEASE:EXCLUDE:END -->
...
Quest3: Avatar only  
<img src="docs/screenshots/v1_quest3_example_loft_avatar_only.jpg" alt="Quest3; all permissions" width="640" height="360">  
Quest3: Camera permissions requested  
<img src="docs/screenshots/v1_quest3_example_loft_all_cams.jpg" alt="Quest3; all permissions" width="640" height="360">  
<img src="docs/screenshots/v1_quest3_example_viaduct_all_cams.jpg" alt="Quest3; all permissions" width="640" height="360">  
<!-- RELEASE:EXCLUDE:END -->
